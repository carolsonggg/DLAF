...
control MyIngress(inout headers hdr,
    ...
    register<bit<1>>(1024) flowlet_id_tb1;
    
    register<bit<16>>(1024) flow_id_tb2;
    register<bit<48>>(1024) last_seen2;
    register<bit<1>>(1024) flowlet_id_tb2;
		...
		if (hdr.ipv4.isValid()){
	            ...
	            flow_id_tb2.read(flow_id2, (bit<32>)meta.flow_index2);
                    ...
                    if (flow_id1 == flow_sig) {
                        if (standard_metadata.ingress_global_timestamp - last_pkt_ts1 > 500) {           
            	            find_least_loaded();
	                ...
	                flowlet_id_tb1.read(meta.port_index, (bit<32>)meta.flow_index1);    
                        ...
                        if (standard_metadata.ingress_global_timestamp - last_pkt_ts2 > 500) {    
                            find_least_loaded();       
